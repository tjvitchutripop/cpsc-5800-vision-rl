...
class Args:
    ...
    wandb_project_name: str = "vision-rl"
...
if __name__ == "__main__":
    ...
    # env setup
    env_kwargs = dict(obs_mode="rgb+depth+segmentation", render_mode=args.render_mode, sim_backend="physx_cuda")
    ...
    envs = FlattenRGBDSegObservationWrapper(envs, rgb=args.rgb, depth=args.depth, segmentation=args.segmentation, state=args.include_state)
    eval_envs = FlattenRGBDSegObservationWrapper(eval_envs, rgb=args.rgb, depth=args.depth, segmentation=args.segmentation, state=args.include_state)
